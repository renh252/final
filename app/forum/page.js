...
const ForumPage = () => {
  ...
  const mockFeaturedArticles = [
    ...
    },
    {
      ...
      author: '寵物營養師',
      date: '2025-03-14',
      excerpt: '雖然狗狗總是眼巴巴地看著你的食物，但某些人類食物對狗狗有致命危險...',
      likes: 287,
      comments: 63
    },
    {
      ...
      author: '小動物行為專家',
      date: '2025-03-12',
      excerpt: '每個兔子主人都應該了解這些常見行為背後的含義，以建立更好的互動關係...',
      likes: 248,
      comments: 42
    }
  ];
  ...
  const mockPinnedArticles = [
    {
      ...
      likes: 123,
      comments: 45,
      excerpt: '親愛的會員，我們更新了論壇使用規則，請務必閱讀以確保您的發言符合社區準則。'
    },
    {
      id: 'p2',
      title: '【資源整理】寵物急救知識大全',
  ...
  const mockArticles = [
    {
      ...
      likes: 156,
      comments: 42,
      excerpt: '選擇正確的貓糧對貓咪健康至關重要。本文將從營養需求、年齡階段等多角度分析如何為您的愛貓挑選合適的食物。'
    },
    {
      id: '2',
      ...
      likes: 203,
      comments: 53,
      excerpt: '透過正確的獎勵機制和持續練習，可以有效地教會狗狗坐下、握手等基本指令，建立良好的溝通基礎。'
    },
    {
      id: '3',
      title: '寵物鳥的家居環境布置指南',
      ...
      likes: 89,
      comments: 17,
      excerpt: '鳥籠的選擇、玩具的擺放、安全隱患的排除...這些都是讓您的寵物鳥健康快樂生活的關鍵。'
    },
    {
      id: '4',
      ...
      likes: 142,
      comments: 35,
      excerpt: '飼養兔子看似簡單，但有許多細節需要注意。本文整理了新手飼養兔子時最常遇到的問題和解決方法。'
    },
    {
      id: '5',
      ...
      likes: 76,
      comments: 24,
      excerpt: '良好的水質是魚缸生態系統的基礎。本文分享專業的水質管理和定期保養方法，讓您的水族箱常保清澈健康。'
    },
    {
      id: '6',
      title: '多貓家庭和平共處的秘訣',
      ...
      likes: 187,
      comments: 63,
      excerpt: '當家裡有多隻貓咪時，如何避免領地衝突、建立和諧的貓咪社會結構？本文提供實用建議。'
    },
    {
      id: '7',
      ...
      likes: 231,
      comments: 47,
      excerpt: '狗狗進入老年階段後，飲食、運動和醫療照顧都需要調整。本文幫助您理解老年犬的特殊需求。'
    },
    {
      id: '8',
      ...
      likes: 94,
      comments: 28,
      excerpt: '一個好的倉鼠籠不只是睡覺的地方，更是遊樂場和探險天地。本文教您打造理想的倉鼠居住環境。'
    }
  ];
  ...
  const handlePageChange = async (page) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const paginatedArticles = [...mockArticles.slice(startIndex), ...mockArticles.slice(0, startIndex)].slice(0, 8);
